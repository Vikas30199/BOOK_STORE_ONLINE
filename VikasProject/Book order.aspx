<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book order.aspx.cs" Inherits="VikasProject.Book_order" %>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style3">
                        ...
                        <table class="auto-style1">
                            <tr>
                                <td class="auto-style12" colspan="2"><strong>&nbsp;BOOK ORDER</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style22"><strong>DELIVERY ADDRESS</strong></td>
                                <td class="auto-style23">
                                    <asp:TextBox ID="TextBox24" runat="server" Height="29px" Width="334px" OnTextChanged="TextBox24_TextChanged"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style18" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="Button2" runat="server" BackColor="#FF3300" BorderColor="Black" BorderStyle="Groove" BorderWidth="3px" CssClass="auto-style9" Font-Bold="True" ForeColor="#006600" Height="43px" OnClick="Button1_Click" Text="Confirm Order" Width="303px" />
                                    &nbsp;</td>
                            </tr>
                            </table>
                        <br class="auto-style11" />
